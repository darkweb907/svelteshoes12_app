import { c as create_ssr_component, f as add_attribute, d as each, e as escape } from "./ssr.js";
const logo = "/_app/immutable/assets/logo.72890cd3.png";
const navbar_svelte_svelte_type_style_lang = "";
const css = {
  code: ".mage.svelte-wrxp5b{flex:1}.link.svelte-wrxp5b{flex:3}",
  map: null
};
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `  <nav class="bg-transparent py-3"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class="flex items-center justify-between h-16 px-4"><div class="flex-shrink-0 mage svelte-wrxp5b" data-svelte-h="svelte-2pvjx2"><a href="/"><img class="mt-5 w-1/3 md:w-1/2"${add_attribute("src", logo, 0)} alt="Logo"></a></div> <div class="hidden md:block link svelte-wrxp5b"><div class="flex items-baseline space-x-2 justify-end">${each(links, (link) => {
